  ...
  <section className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative'>
    ...
    <div className='z-10'><h5 className='text-xl font-bold text-white my-2'>Let's Connect</h5>
      <p className='text-[#ADB7BE] mb-4 max-w-md'>
        {""}
      I'm currently looking for new opportunities, feel free to connect with me. Whether you have a a question or just wanted to say him I'll try my best to get back to you!
      </p>
